...
<div class="row">
  <div class="col-md-6">
      <div class="list-group">
        ...
        <a href="{{ route('lp.batch.index') }}" class="list-group-item"><span class="glyphicon glyphicon-sunglasses" aria-hidden="true"></span>AG LP List</a>
        <a data-toggle="modal" href="#createLiftingProgramModal" class="list-group-item"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>Create New AG LP</a>
